...
/**
 * This class performs as an interface between the ClientSocketConnector class,
 * Graph Thread and the UI classes to connect to the socket.
 * 
...
public class ClientSocketController {
	...
	/**
	 * Starts the graph thread when needed to update the graph on successful
	...
	public void startServer(int channelNumber) {
		clientSocketConnector = new ClientSocketConnector(HOSTNAME, PORT_NUM,
				channelNumber);
