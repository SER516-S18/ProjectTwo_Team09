...
/**
 * Server Status indicator Panel - If the server is running 
 * it is indicated by a green blinking circle. If its stopped
 * it is indicated by a red circle.
 * 
 * @author Nelson Tran
 * @version 1.0
 * @since 2018-02-23
...
public class StatusPanel extends JPanel {
    ...
    * is running and a green blinking circle. If `blink` is false, then 
    * the server is not running and is indicated by a (non-blinking) 
    * red circle.
    ...
    */
     ...
     * @param graphics - Graphics object to change the color 
     * 					 the circle 
     */
    @Override
